...
<body>
  ...
  <div class="container">
    <div class="row mt-5">
      <div class="col-lg-12 d-flex justify-content-between align-items-center">
        ...
        <div>
          <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#cadRevendaModal">
            Nova Revenda
          </button>
        </div>
      </div>
  ...
  <div class="modal fade" id="cadRevendaModal" tabindex="-1" aria-labelledby="cadRevendaModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="cadRevendaModalLabel">Cadastrar Revenda</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form id="cadRevendaForm" class="row g-3 mt-3">
            <div class="col-md-4">
            ...
            <div class="col-md-3">
              <label for="FONE_EMPRESA" class="form-label">Telefone Loja</label>
            ...
            <div class="modal-footer">
              ...
              <input type="submit" class="btn btn-success" value="Gravar" id="cadRevendaBtn">
            </div>
          </form>
        </div>
      </div>
  ...
  <div class="modal fade" id="editRevendaModal" tabindex="-1" aria-labelledby="editRevendaModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editRevendaModalLabel">Editar Revenda</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form id="editRevendaForm" class="row g-3 mt-3">
            ...
            <div class="col-md-6">
              <label for="CIDADE" class="form-label">Cidade</label>
              <input name="CIDADE" type="text" class="form-control" id="editCIDADE" required>
            </div>
            <div class="col-md-3">
              <label for="UF" class="form-label">UF</label>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
              <input type="submit" class="btn btn-success" value="Salvar" id="editRevendaBtn">
            </div>
          </form>
        </div>
      </div>
  ...
  <div class="modal fade" id="infoRevenda" tabindex="-1" aria-labelledby="infoRevendaLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="infoRevendaLabel">Detalhes Revenda</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="row">
                ...
                <div class="col mb-2">
                  Telefone Loja: <span id="foneLoja"></span>
                </div>
              </div>
              <hr>
              <div class="row">
                <div class="col mb-2">
                  Tipo de Revenda: <span id="tipo"></span>
                </div>
              </div>
